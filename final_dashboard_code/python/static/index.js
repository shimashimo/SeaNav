/* Javascript file for index.html to run SeaNav dashboard */

/* Run Matlab script on click of a button/call back to Python function */
...
/* Setup config for IMU graph for various types of data */
const imuConfig = {
    type: 'line',
    data: {
      datasets: [
...
/* Convert float to two decimal places for output to dashboard */
...
evtSource.onmessage = function(event) {
    ...
    // Send a notification for reached depth threshold
    ...
    // Send a notification for approaching depth threshold
    ...
    // Send IMU data to HTML real-time table
    ...
    // Send IMU Calibration data to HTML real-time table
    ...
    // Send Pressure Sensor data to HTML real-time table
...
// Sketches for 3-D model and radar

// Sketch for 3-D Model
...
// Set starting coordinates for graph
var latitude = 0;
var longitude = 0;
...
// Move the GPS location to the most recent data  
